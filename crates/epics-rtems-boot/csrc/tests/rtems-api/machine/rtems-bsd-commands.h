...
#ifndef EPICS_RS_RECORDED_MACHINE_RTEMS_BSD_COMMANDS_H
#define EPICS_RS_RECORDED_MACHINE_RTEMS_BSD_COMMANDS_H

/* @rtems-api machine/rtems-bsd-commands.h */
...
#endif /* EPICS_RS_RECORDED_MACHINE_RTEMS_BSD_COMMANDS_H */
