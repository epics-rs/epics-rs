...
/// nothing — a moved directory, a renamed manifest — into a failure. 55 files
/// at the time of writing, which is the smallest of the four crates that
/// declare the feature, so the floor is set proportionally lower.
const MIN_FILES: usize = 45;
