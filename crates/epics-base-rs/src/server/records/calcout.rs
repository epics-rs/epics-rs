...
static CALCOUT_FIELDS: &[FieldDesc] = &[
    ...
    FieldDesc::new("OEVT", DbFieldType::String, false),
    ...
    FieldDesc::new("INMV", DbFieldType::Enum, true),
    FieldDesc::new("INNV", DbFieldType::Enum, true),
    FieldDesc::new("INOV", DbFieldType::Enum, true),
    FieldDesc::new("INPV", DbFieldType::Enum, true),
    FieldDesc::new("INQV", DbFieldType::Enum, true),
    FieldDesc::new("INRV", DbFieldType::Enum, true),
    FieldDesc::new("INSV", DbFieldType::Enum, true),
    FieldDesc::new("INTV", DbFieldType::Enum, true),
    FieldDesc::new("INUV", DbFieldType::Enum, true),
