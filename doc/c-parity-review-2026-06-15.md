...
#### ADP-99: NDFileHDF5 pre-compressed direct-chunk-write not ported; HDF5 writer not compression-aware
Severity: Medium — feature — **UNFIXED, backend-blocked** (rust-hdf5 0.2.17 has no filter-bypassing direct-chunk-write)
