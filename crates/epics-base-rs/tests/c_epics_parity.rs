...
async fn db_link_alarm_propagation() {
    ...
    db.add_record("target", Box::new(AoRecord::new(42.0))).await.unwrap();
    db.add_record("src", Box::new(AiRecord::new(0.0))).await.unwrap();
...
async fn soft_input_reads_from_db_link() {
    ...
    db.add_record("source", Box::new(LonginRecord::new(0)))
        .await.unwrap();
    db.add_record("reader", Box::new(AiRecord::new(0.0))).await.unwrap();
...
async fn soft_output_writes_to_db() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("dest", Box::new(AoRecord::new(0.0))).await.unwrap();
...
async fn database_multiple_records() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("ai1", Box::new(AiRecord::new(1.0))).await.unwrap();
    db.add_record("ai2", Box::new(AiRecord::new(2.0))).await.unwrap();
    db.add_record("bo1", Box::new(BoRecord::new(0))).await.unwrap();
...
async fn database_put_record_field() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("myrec", Box::new(AoRecord::new(0.0))).await.unwrap();
...
async fn database_all_record_names() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("rec_a", Box::new(AiRecord::new(0.0))).await.unwrap();
    db.add_record("rec_b", Box::new(AoRecord::new(0.0))).await.unwrap();
    db.add_record("rec_c", Box::new(BiRecord::new(0))).await.unwrap();
...
async fn database_init_cleanup_cycle() {
    ...
    {
        let db = Arc::new(PvDatabase::new());
        db.add_record("cycle1", Box::new(AoRecord::new(1.0))).await.unwrap();
    ...
    // Cycle 2: fresh database, old records gone
    {
        ...
        db.add_record("cycle2", Box::new(AoRecord::new(2.0))).await.unwrap();
...
async fn flnk_chain_processes_target() {
    ...
    use std::sync::Arc;
    let db = Arc::new(PvDatabase::new());
    db.add_record("src", Box::new(AoRecord::new(0.0))).await.unwrap();
    db.add_record("dst", Box::new(AiRecord::new(0.0))).await.unwrap();
...
async fn flnk_loop_does_not_infinite_loop() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("loop_a", Box::new(AoRecord::new(0.0))).await.unwrap();
    db.add_record("loop_b", Box::new(AoRecord::new(0.0))).await.unwrap();
...
async fn rapid_puts_to_same_record() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("rapid", Box::new(AoRecord::new(0.0))).await.unwrap();
...
async fn independent_records_no_interference() {
    ...
    let db = Arc::new(PvDatabase::new());
    db.add_record("iso_a", Box::new(AoRecord::new(1.0))).await.unwrap();
    db.add_record("iso_b", Box::new(AoRecord::new(2.0))).await.unwrap();
