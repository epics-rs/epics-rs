...
| [#862](https://github.com/epics-base/epics-base/pull/862), [#863](https://github.com/epics-base/epics-base/issues/863) | DNS TTL refresh of HAG / CA hostname state | `/reload-acf` introspection exists; no automatic TTL refresh | partial — manual `/reload-acf` works; automatic TTL-driven refresh of HAG hostname→IP cache deferred (no upstream merge yet, design open). Operator workaround documented. |
