...
static ACALCOUT_FIELDS: &[FieldDesc] = &[
    ...
    FieldDesc::new("AVAL", DbFieldType::Double, false),
    FieldDesc::new("PVAL", DbFieldType::Double, false),
    // sizing — SPC_NOMOD NELM kept read_only, .db-settable via the loader path
    FieldDesc::new("NELM", DbFieldType::ULong, true),
    FieldDesc::new("NUSE", DbFieldType::ULong, false),
    // CALC / OCAL
    ...
    FieldDesc::new("OAV", DbFieldType::Double, false),
    FieldDesc::new("POVL", DbFieldType::Double, false),
    // scalar inputs A..L
    ...
    FieldDesc::new("AA", DbFieldType::Double, false),
    FieldDesc::new("BB", DbFieldType::Double, false),
    FieldDesc::new("CC", DbFieldType::Double, false),
    FieldDesc::new("DD", DbFieldType::Double, false),
    FieldDesc::new("EE", DbFieldType::Double, false),
    FieldDesc::new("FF", DbFieldType::Double, false),
    FieldDesc::new("GG", DbFieldType::Double, false),
    FieldDesc::new("HH", DbFieldType::Double, false),
    FieldDesc::new("II", DbFieldType::Double, false),
    FieldDesc::new("JJ", DbFieldType::Double, false),
    FieldDesc::new("KK", DbFieldType::Double, false),
    ...
    FieldDesc::new("INAV", DbFieldType::Short, true),
    FieldDesc::new("INBV", DbFieldType::Short, true),
    FieldDesc::new("INCV", DbFieldType::Short, true),
    FieldDesc::new("INDV", DbFieldType::Short, true),
    FieldDesc::new("INEV", DbFieldType::Short, true),
    FieldDesc::new("INFV", DbFieldType::Short, true),
    FieldDesc::new("INGV", DbFieldType::Short, true),
    FieldDesc::new("INHV", DbFieldType::Short, true),
    FieldDesc::new("INIV", DbFieldType::Short, true),
    FieldDesc::new("INJV", DbFieldType::Short, true),
    FieldDesc::new("INKV", DbFieldType::Short, true),
    FieldDesc::new("INLV", DbFieldType::Short, true),
    FieldDesc::new("IAAV", DbFieldType::Short, true),
    FieldDesc::new("IBBV", DbFieldType::Short, true),
    FieldDesc::new("ICCV", DbFieldType::Short, true),
    FieldDesc::new("IDDV", DbFieldType::Short, true),
    FieldDesc::new("IEEV", DbFieldType::Short, true),
    FieldDesc::new("IFFV", DbFieldType::Short, true),
    FieldDesc::new("IGGV", DbFieldType::Short, true),
    FieldDesc::new("IHHV", DbFieldType::Short, true),
    FieldDesc::new("IIIV", DbFieldType::Short, true),
    FieldDesc::new("IJJV", DbFieldType::Short, true),
    FieldDesc::new("IKKV", DbFieldType::Short, true),
    FieldDesc::new("ILLV", DbFieldType::Short, true),
    FieldDesc::new("OUTV", DbFieldType::Short, true),
    // output options
    FieldDesc::new("OOPT", DbFieldType::Short, false),
    FieldDesc::new("ODLY", DbFieldType::Double, false),
    FieldDesc::new("WAIT", DbFieldType::Short, false),
    FieldDesc::new("DLYA", DbFieldType::UShort, true),
    ...
    FieldDesc::new("PA", DbFieldType::Double, true),
    FieldDesc::new("PB", DbFieldType::Double, true),
    FieldDesc::new("PC", DbFieldType::Double, true),
    FieldDesc::new("PD", DbFieldType::Double, true),
    FieldDesc::new("PE", DbFieldType::Double, true),
    FieldDesc::new("PF", DbFieldType::Double, true),
    FieldDesc::new("PG", DbFieldType::Double, true),
    FieldDesc::new("PH", DbFieldType::Double, true),
    FieldDesc::new("PI", DbFieldType::Double, true),
    FieldDesc::new("PJ", DbFieldType::Double, true),
    FieldDesc::new("PK", DbFieldType::Double, true),
    FieldDesc::new("PL", DbFieldType::Double, true),
    ...
    // diagnostics
    FieldDesc::new("NEWM", DbFieldType::ULong, true),
    FieldDesc::new("CACT", DbFieldType::Char, true),
    FieldDesc::new("CSTAT", DbFieldType::Long, true),
    FieldDesc::new("AMASK", DbFieldType::ULong, true),
    FieldDesc::new("SIZE", DbFieldType::Short, false),
    FieldDesc::new("AMEM", DbFieldType::Long, true),
    FieldDesc::new("PMEM", DbFieldType::Long, true),
    FieldDesc::new("VERS", DbFieldType::Double, true),
];
